...
(function() {
  ...
  BubbleChart = (function() {
    function BubbleChart(data) {
      ...
      this.force = null;
      this.circles = null;
      this.fill_color = d3.scale.ordinal().domain(["low", "medium", "high"]).range(["#756bb1", "#bcbddc","#efedf5"]);
      max_amount = d3.max(this.data, function(d) {
        return parseInt(d.total);
      });
      this.radius_scale = d3.scale.pow().exponent(0.5).domain([0, max_amount]).range([2, 75]);
      this.create_nodes();
      this.create_vis();
    }
    ...
    BubbleChart.prototype.create_vis = function() {
      ...
      that = this;
      this.circles.enter().append("circle").attr("r", 10).attr("fill", (function(_this) {
        return function(d) {
  ...
  $(function() {
    ...
    return d3.csv("data/brand.csv", render_vis);
  });
